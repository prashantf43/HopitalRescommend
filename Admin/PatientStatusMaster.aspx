<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="PatientStatusMaster.aspx.cs" Inherits="Admin_PatientStatusMaster" %>
                    ...
                    <div class="form-horizontal form-bordered">
                        <div class="form-group" style="border-bottom: none;">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="txtStatus" placeholder="Enter Status" MaxLength="150"
                                        CssClass="form-control" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator1" runat="server"
                                        ControlToValidate="txtStatus" ForeColor="Red">Please Status</asp:RequiredFieldValidator>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Status" ItemStyle-CssClass="gridText-left">
                                                <ItemTemplate>
                                                    <asp:Label CssClass="me" ID="lblPatientStatus" runat="server" Text='<%#Bind("PatientStatus")%>'></asp:Label>
                                                    <asp:HiddenField ID="HfPatientStatusId" runat="server" Value='<%#Bind("PatientStatusId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnEdit" runat="server" AlternateText="Edit" CommandName="Updates"
                                                        CommandArgument='<%#Bind("PatientStatusId")%>' CausesValidation="false" data-toggle="tooltip"
                                        ...
                                        <i class="fa fa-pencil" style="line-height:inherit;"></i>
                                                    ...
                                                    <asp:LinkButton ID="btnDel" runat="server" AlternateText="Delete" CommandName="deletes"
                                                        CommandArgument='<%#Bind("PatientStatusId")%>' OnClientClick="return confirm('Are you sure you want to delete this Record?');"
