<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="DiseaseMaster.aspx.cs" Inherits="Admin_DiseaseMaster" %>
                    ...
                    <div class="form-horizontal form-bordered">
                        <div class="form-group" style="border-bottom: none;">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="txtDisease" placeholder="Enter Disease Name" MaxLength="150"
                                        CssClass="form-control" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator1" runat="server"
                                        ControlToValidate="txtDisease" ForeColor="Red">Please Disease Name</asp:RequiredFieldValidator>
                                </div>
                            </div>
                                    ...
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Service" ItemStyle-CssClass="gridText-left">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="HfDiseaseId" runat="server" Value='<%#Bind("DiseaseId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnEdit" runat="server" AlternateText="Edit" CommandName="Updates"
                                                        CommandArgument='<%#Bind("DiseaseId")%>' CausesValidation="false" data-toggle="tooltip"
                                        ...
                                        <i class="fa fa-pencil" style="line-height:inherit;"></i>
                                                    ...
                                                    <asp:LinkButton ID="btnDel" runat="server" AlternateText="Delete" CommandName="deletes"
                                                        CommandArgument='<%#Bind("DiseaseId")%>' OnClientClick="return confirm('Are you sure you want to delete this Record?');"
