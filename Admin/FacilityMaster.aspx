<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="FacilityMaster.aspx.cs" Inherits="Admin_FacilityMaster" %>
                    ...
                    <div class="form-horizontal form-bordered">
                        <div class="form-group" style="border-bottom: none;">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="txtFacility" placeholder="Enter Facility Name" MaxLength="150"
                                        CssClass="form-control" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator1" runat="server"
                                        ControlToValidate="txtFacility" ForeColor="Red">Please Facility Name</asp:RequiredFieldValidator>
                                </div>
                            </div>
                                    ...
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Service" ItemStyle-CssClass="gridText-left">
                                                <ItemTemplate>
                                                    <asp:Label CssClass="me" ID="lblFacility" runat="server" Text='<%#Bind("FacilityName")%>'></asp:Label>
                                                    <asp:HiddenField ID="HfFacilityId" runat="server" Value='<%#Bind("FacilityId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnEdit" runat="server" AlternateText="Edit" CommandName="Updates"
                                                        CommandArgument='<%#Bind("FacilityId")%>' CausesValidation="false" data-toggle="tooltip"
                                        ...
                                        <i class="fa fa-pencil" style="line-height:inherit;"></i>
                                                    ...
                                                    <asp:LinkButton ID="btnDel" runat="server" AlternateText="Delete" CommandName="deletes"
                                                        CommandArgument='<%#Bind("FacilityId")%>' OnClientClick="return confirm('Are you sure you want to delete this Record?');"
