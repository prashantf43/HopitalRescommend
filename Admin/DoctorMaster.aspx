<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="DoctorMaster.aspx.cs" Inherits="Admin_DoctorMaster" %>
                    ...
                    <div class="form-horizontal form-bordered">
                        <div class="form-group" style="border-bottom: none;">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="txtDoctorName" placeholder="Enter Doctor Name"
                                        CssClass="form-control" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator1" runat="server"
                                        ControlToValidate="txtDoctorName" ForeColor="Red">Please Doctor Name</asp:RequiredFieldValidator>
                                </div>
                            </div>
                                    ...
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Disease" ItemStyle-CssClass="gridText-left">
                                                <ItemTemplate>
                                                    <asp:Label CssClass="me" ID="lblDisease" runat="server" Text='<%#Bind("DiseaseName")%>'></asp:Label>
                                                    <asp:HiddenField ID="HfTreatmentId" runat="server" Value='<%#Bind("DoctorId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Doctor" ItemStyle-CssClass="gridText-left">
                                                <ItemTemplate>
                                                    <asp:Label CssClass="me" ID="lblDoctor" runat="server" Text='<%#Bind("DoctorName")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnEdit" runat="server" AlternateText="Edit" CommandName="Updates"
                                                        CommandArgument='<%#Bind("DoctorId")%>' CausesValidation="false" data-toggle="tooltip"
                                        ...
                                        <i class="fa fa-pencil" style="line-height:inherit;"></i>
                                                    ...
                                                    <asp:LinkButton ID="btnDel" runat="server" AlternateText="Delete" CommandName="deletes"
                                                        CommandArgument='<%#Bind("DoctorId")%>' OnClientClick="return confirm('Are you sure you want to delete this Record?');"
