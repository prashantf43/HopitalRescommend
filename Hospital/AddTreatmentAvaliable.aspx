<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="AddTreatmentAvaliable.aspx.cs" Inherits="Hospital_AddTreatmentAvaliable" %>
                    ...
                    <div class="form-horizontal form-bordered">
                        ...
                        <div class="form-group" style="border-bottom: none;">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <asp:DropDownList ID="ddlTreatment" runat="server" CssClass="form-control">
                                    </asp:DropDownList>
