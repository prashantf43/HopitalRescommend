<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="AddDoctorAvaliable.aspx.cs" Inherits="Hospital_AddDoctorAvaliable" %>
                                    ...
                                    <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="false" AllowPaging="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Doctor" ItemStyle-CssClass="gridText-left">
                                                <ItemTemplate>
                                                    <asp:Label CssClass="me" ID="lblTreatment" runat="server" Text='<%#Bind("DoctorName")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
