<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="AddPatient.aspx.cs" Inherits="Hospital_AddPatient" %>
                    ...
                    <div class="form-horizontal form-bordered">
                        <div class="form-group" style="border-bottom: none;">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <asp:TextBox ID="txtDateOfAdmission" placeholder="Enter Date Of Admission"
                                        CssClass="form-control" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator6" runat="server"
                                        ControlToValidate="txtDateOfAdmission" ForeColor="Red">Please Enter Date Of Admission</asp:RequiredFieldValidator>
                                    
                                <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtDateOfAdmission" Format="dd-MM-yyyy"></asp:CalendarExtender>
                                </div>
                            </div>
