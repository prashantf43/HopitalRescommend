                ...
                <div class="col-xs-6 login-inner" style="">
                    ...
                    <div class="block col-xs-12" style="padding: 10px 0 0 0px; border: none; background-color: #F2F2F2;">
                        <div class="form-group">
                            <div class="col-xs-10">
                                <asp:TextBox ID="txtAadharNumber" placeholder="Aadhar Number" class="form-control input-lg"
                                    runat="server">
                                </asp:TextBox>
                                <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator2" runat="server"
                                    ControlToValidate="txtAadharNumber" ForeColor="Red">*</asp:RequiredFieldValidator>
                            </div>
                        </div>
        ...
        <div class="wrapper">
            <div style="border-top: 1px solid #E8E8E8;">
                <div class="login-menu">
                  Other Login &nbsp; <asp:Button ID="btnAdminLogin" runat="server" CssClass="btn btn-primary2" Text="Admin" CausesValidation="false"
                    ...
                    <asp:Button ID="btnHospital" runat="server" CssClass="btn btn-primary2" Text="Hospital" CausesValidation="false"
                     ...
                     &nbsp;
                    <asp:Button ID="btnGuest" runat="server" CssClass="btn btn-primary2" Text="Guest" CausesValidation="false"
